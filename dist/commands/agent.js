import { listAgentIds, resolveAgentDir, resolveAgentModelFallbacksOverride, resolveAgentModelPrimary, resolveAgentSkillsFilter, resolveAgentWorkspaceDir, } from "../agents/agent-scope.js";
...
export async function agentCommand(opts, runtime = defaultRuntime, deps = createDefaultDeps()) {
    ...
    try {
        ...
        const needsSkillsSnapshot = isNewSession || !sessionEntry?.skillsSnapshot || (skillsSnapshotVersion > 0 && (sessionEntry?.skillsSnapshot?.version ?? 0) < skillsSnapshotVersion);
