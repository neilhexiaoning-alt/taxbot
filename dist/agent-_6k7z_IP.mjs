import { B as normalizeThinkLevel, F as formatXHighModelHint, H as normalizeVerboseLevel, P as formatThinkingLevels, W as supportsXHighThinking } from "./pi-embedded-helpers-DIV_C5J8.mjs";
import { $t as getRemoteSkillEligibility, F as resolveOutboundTarget, I as resolveSessionDeliveryTarget, Si as loadModelCatalog, Ui as resolveAgentTimeoutMs, W as runWithModelFallback, _i as applyVerboseOverride, fn as getSkillsSnapshotVersion, gi as applyModelOverrideToSessionEntry, gr as emitAgentEvent, hi as clearSessionAuthProfileOverride, hr as clearAgentRunContext, i as runCliAgent, l as runEmbeddedPiAgent, mi as lookupContextTokens, mr as AGENT_LANE_NESTED, n as getCliSessionId, pt as hasNonzeroUsage, r as setCliSessionId, s as resolveSendPolicy, yr as registerAgentRunContext } from "./reply-CReGWUt7.mjs";
import { F as normalizeMainKey, I as resolveAgentIdFromSessionKey, P as normalizeAgentId, a as resolveAgentModelPrimary, i as resolveAgentModelFallbacksOverride, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, x as ensureAgentWorkspace } from "./agent-scope-BD88ooNs.mjs";
import { c as defaultRuntime, h as DEFAULT_CHAT_CHANNEL } from "./subsystem-iSHcgawR.mjs";
import { a as modelKey, ht as DEFAULT_PROVIDER, i as isCliProvider, it as ensureAuthProfileStore, l as resolveConfiguredModelRef, mt as DEFAULT_MODEL, p as resolveThinkingDefault, pt as DEFAULT_CONTEXT_TOKENS, t as buildAllowedModelSet } from "./model-selection-DNDKru6x.mjs";
import { t as formatCliCommand } from "./command-format-CRQZQg6U.mjs";
import { i as loadConfig } from "./config-B_uz17RB.mjs";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-DSII6JvY.mjs";
import { A as resolveSessionResetPolicy, D as resolveSessionKey, I as resolveExplicitAgentSessionKey, O as evaluateSessionFreshness, T as normalizeAccountId, d as loadSessionStore, g as updateSessionStore, j as resolveSessionResetType, k as resolveChannelResetConfig } from "./sandbox-oRz8OYlY.mjs";
import { r as buildWorkspaceSkillSnapshot } from "./skills-Cb4fWMT0.mjs";
import { a as isInternalMessageChannel, d as resolveMessageChannel, i as isGatewayMessageChannel, l as normalizeMessageChannel, n as isDeliverableMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-Ls7G_LaM.mjs";
import { n as resolveSessionFilePath, o as resolveStorePath } from "./paths-D0n0xdZb.mjs";
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-DeFlE7gj.mjs";
