...
import { E as resolveOpenClawPackageRoot } from "./agent-scope-BD88ooNs.mjs";
...
import { n as replaceCliName, r as resolveCliName, t as formatCliCommand } from "./command-format-CRQZQg6U.mjs";
...
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-DXmBJpDK.mjs";
import { o as trimLogTail } from "./restart-sentinel-BSJCs5vQ.mjs";
import { r as parseSemver } from "./runtime-guard-DFX3Ovni.mjs";
import "./archive-7jXYzIVl.mjs";
import "./installs-ChQ-kMei.mjs";
import { a as globalInstallArgs, c as compareSemverStrings, d as DEFAULT_GIT_CHANNEL, f as DEFAULT_PACKAGE_CHANNEL, g as resolveEffectiveUpdateChannel, h as normalizeUpdateChannel, i as detectGlobalInstallManagerForRoot, l as fetchNpmTagVersion, m as formatUpdateChannelLabel, n as cleanupGlobalRenameDirs, o as resolveGlobalPackageRoot, p as channelToNpmTag, r as detectGlobalInstallManagerByPresence, s as checkUpdateStatus, t as runGatewayUpdate, u as resolveNpmChannelTag } from "./update-runner-Dy5Zj6kW.mjs";
import { t as renderTable } from "./table-DWsrGl_1.mjs";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-DcPF_ckr.mjs";
import { t as formatHelpExamples } from "./help-format-Va6KVo1b.mjs";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-DZCHUyma.mjs";
...
async function updateCommand(opts) {
	...
	if (shouldRestart) {
		...
		try {
			const { runDaemonRestart } = await import("./daemon-cli-DknrfFYx.mjs").then((n) => n.t);
			...
			if (!opts.json && restarted) {
				...
				try {
					const { doctorCommand } = await import("./doctor-tgary4l1.mjs").then((n) => n.n);
