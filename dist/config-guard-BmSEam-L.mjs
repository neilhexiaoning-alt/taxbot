import { A as runMessageAction, At as detectBrowserOpenSupport, B as CHANNEL_MESSAGE_ACTION_NAMES, Bt as randomToken, Dt as DEFAULT_WORKSPACE, Ft as moveToTrash, L as formatTargetDisplay, Lt as openUrl, Mt as formatControlUiSshHint, Ot as applyWizardMetadata, Pt as handleReset, Vt as resolveControlUiLinks, Wt as waitForGatewayReachable, bn as runMemoryStatus, ft as resolveCommitHash, jt as ensureWorkspaceAndSessions, mi as lookupContextTokens, nt as CHANNEL_TARGETS_DESCRIPTION, rt as CHANNEL_TARGET_DESCRIPTION, yn as registerMemoryCli } from "./reply-CReGWUt7.mjs";
import { g as resolveStateDir, i as isNixMode, m as resolveOAuthDir, o as resolveConfigPath, r as STATE_DIR, u as resolveGatewayPort } from "./paths-DcBT4Q4r.mjs";
import { D as DEFAULT_ACCOUNT_ID, O as DEFAULT_AGENT_ID, P as normalizeAgentId, c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-BD88ooNs.mjs";
import { D as info, E as danger, I as colorize, L as isRich, M as setVerbose, R as theme, S as normalizeChatChannelId, c as defaultRuntime, h as DEFAULT_CHAT_CHANNEL, l as restoreTerminalState, s as visibleWidth, v as getChatChannelMeta } from "./subsystem-iSHcgawR.mjs";
import { _ as shortenHomePath, g as shortenHomeInString, h as resolveUserPath, p as resolveHomeDir } from "./utils-D9-prTJL.mjs";
import { t as runCommandWithTimeout } from "./exec-BRaJtAm2.mjs";
import { J as resolveApiKeyForProfile, P as resolveEnvApiKey, U as resolveAuthProfileOrder, ht as DEFAULT_PROVIDER, it as ensureAuthProfileStore, l as resolveConfiguredModelRef, mt as DEFAULT_MODEL, o as normalizeProviderId, pt as DEFAULT_CONTEXT_TOKENS, rt as upsertAuthProfile, st as resolveAuthStorePath } from "./model-selection-DNDKru6x.mjs";
import { t as formatCliCommand } from "./command-format-CRQZQg6U.mjs";
import { t as parseBooleanValue } from "./boolean-B7lX4AU9.mjs";
import { M as parseDurationMs, c as writeConfigFile, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-B_uz17RB.mjs";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-DSII6JvY.mjs";
import { d as loadSessionStore } from "./sandbox-oRz8OYlY.mjs";
import { n as movePathToTrash } from "./server-context-CAvvAxGZ.mjs";
import { l as normalizeMessageChannel, m as GATEWAY_CLIENT_NAMES, p as GATEWAY_CLIENT_MODES } from "./message-channel-Ls7G_LaM.mjs";
import { a as resolveSessionTranscriptsDirForAgent, i as resolveSessionTranscriptsDir, o as resolveStorePath } from "./paths-D0n0xdZb.mjs";
import { n as callGateway, r as randomIdempotencyKey } from "./call-DrwxBANw.mjs";
...
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DXmBJpDK.mjs";
...
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-BTIZSnJm.mjs";
import { t as WizardCancelledError } from "./prompts-TEa_gmaq.mjs";
import { t as createClackPrompter } from "./clack-prompter-CiUsChTN.mjs";
import { a as buildAgentSummaries, c as loadAgentIdentity, f as parseIdentityMarkdown, i as applyAgentConfig, l as pruneAgentConfig, n as statusCommand, o as findAgentEntryIndex, s as listAgentEntries, t as runOnboardingWizard, u as identityHasValues } from "./onboarding-81PdWYa6.mjs";
import { f as warnIfModelConfigLooksOff, g as promptAuthChoiceGrouped, h as applyGoogleGeminiModelDefault, m as upsertSharedEnvVar, p as applyAuthChoice } from "./onboard-skills-CJmeZwSj.mjs";
import { $ as buildTokenProfileId, B as setAnthropicApiKey, C as applyOpenrouterConfig, D as applyVeniceConfig, G as setOpencodeZenApiKey, H as setKimiCodingApiKey, J as setVeniceApiKey, K as setOpenrouterApiKey, N as applyZaiConfig, T as applySyntheticConfig, U as setMinimaxApiKey, V as setGeminiApiKey, W as setMoonshotApiKey, X as setXiaomiApiKey, Y as setVercelAiGatewayApiKey, Z as setZaiApiKey, et as validateAnthropicSetupToken, f as applyOpencodeZenConfig, g as applyMinimaxConfig, j as applyXiaomiConfig, k as applyVercelAiGatewayConfig, m as applyMinimaxApiConfig, q as setSyntheticApiKey, v as applyAuthProfileConfig, x as applyMoonshotConfig, y as applyKimiCodeConfig } from "./github-copilot-auth-DLp_veWW.mjs";
import { n as setupChannels } from "./onboard-channels-B7Nzchqn.mjs";
import { i as healthCommand } from "./health-format-CQglK8Ez.mjs";
import { t as renderTable } from "./table-DWsrGl_1.mjs";
import { t as resolveGatewayService } from "./service-DhHo4Mch.mjs";
import { r as isSystemdUserServiceAvailable } from "./systemd-UR47hdt4.mjs";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-B8vxNXy3.mjs";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-B6MBjPcg.mjs";
import { t as formatHelpExamples } from "./help-format-Va6KVo1b.mjs";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-_6k7z_IP.mjs";
import { n as hasExplicitOptions, t as ensurePluginRegistryLoaded } from "./plugin-registry-F6lXUqFD.mjs";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-BNzNlEr9.mjs";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-C1SagTxm.mjs";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-B-EHQzP_.mjs";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-DSqFRbzY.mjs";
import { r as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-tgary4l1.mjs";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-C1SagTxm.mjs").then((n) => n.t);
