import { Ln as resolveHeartbeatVisibility, Lr as resolveUserTimezone, Mr as resolveEffectiveMessagesConfig, N as resolveHeartbeatDeliveryTarget, P as resolveHeartbeatSenderContext, Rn as emitHeartbeatEvent, Vn as resolveIndicatorType, at as setHeartbeatWakeHandler, di as isHeartbeatContentEffectivelyEmpty, fi as resolveHeartbeatPrompt$1, it as requestHeartbeatNow, li as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, pi as stripHeartbeatToken, ri as CommandLane, t as getReplyFromConfig, ti as getQueueSize, ui as DEFAULT_HEARTBEAT_EVERY, xi as peekSystemEvents } from "./reply-CReGWUt7.mjs";
import { B as toAgentStoreSessionKey, I as resolveAgentIdFromSessionKey, P as normalizeAgentId, c as resolveDefaultAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, s as resolveAgentWorkspaceDir } from "./agent-scope-BD88ooNs.mjs";
import { D as info, I as colorize, L as isRich, R as theme, c as defaultRuntime, t as createSubsystemLogger } from "./subsystem-iSHcgawR.mjs";
import { t as isTruthyEnvValue } from "./env-DE0tkFHW.mjs";
import { M as parseDurationMs, i as loadConfig } from "./config-B_uz17RB.mjs";
import { E as buildChannelAccountBindings, O as resolvePreferredAccountId, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-DSII6JvY.mjs";
import { F as resolveAgentMainSessionKey, P as canonicalizeMainSessionAlias, d as loadSessionStore, g as updateSessionStore, m as saveSessionStore } from "./sandbox-oRz8OYlY.mjs";
import { T as formatErrorMessage } from "./chrome-PKn2zNTL.mjs";
import { o as resolveStorePath } from "./paths-D0n0xdZb.mjs";
import { G as HEARTBEAT_TOKEN, t as deliverOutboundPayloads } from "./deliver-DeFlE7gj.mjs";
...
async function runHeartbeatOnce(opts) {
	...
	try {
		if (isHeartbeatContentEffectivelyEmpty(await fsPromises.readFile(heartbeatFilePath, "utf-8")) && !isExecEventReason) {
			emitHeartbeatEvent({
				status: "skipped",
