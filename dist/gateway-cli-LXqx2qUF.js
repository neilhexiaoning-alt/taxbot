...
import { A as isCliProvider, F as resolveAllowedModelRef, Ft as DEFAULT_MODEL, It as DEFAULT_PROVIDER, L as resolveConfiguredModelRef, Pt as DEFAULT_CONTEXT_TOKENS, R as resolveDefaultModelForAgent, T as isPidAlive, V as resolveThinkingDefault, k as getModelRefStatus, yt as normalizeSecretInput, z as resolveHooksGmailModel } from "./auth-profiles-GYsKiVaE.js";
import { t as formatCliCommand } from "./command-format-Cutkv9UT.js";
import { b as isSubagentSessionKey, d as resolveAgentIdFromSessionKey, i as buildAgentMainSessionKey, l as normalizeAgentId, m as toAgentRequestSessionKey, n as DEFAULT_AGENT_ID, s as classifySessionKeyShape, t as DEFAULT_ACCOUNT_ID, u as normalizeMainKey, v as isCronRunSessionKey, x as parseAgentSessionKey } from "./session-key-BGiG_JcT.js";
...
import { l as hasBinary } from "./frontmatter-CEDVhyuu.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-WdwyspYD.js";
import { s as isTestDefaultMemorySlotDisabled } from "./manifest-registry-QAG6awiS.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CXVlWZRW.js";
...
import { $ as validateNodePairRequestParams, A as validateCronStatusParams, B as validateExecApprovalsNodeGetParams, C as validateConfigSetParams, Ct as validateWizardCancelParams, D as validateCronRemoveParams, Dt as PROTOCOL_VERSION, E as validateCronListParams, Et as validateWizardStatusParams, F as validateDeviceTokenRevokeParams, G as validateNodeDescribeParams, H as validateExecApprovalsSetParams, I as validateDeviceTokenRotateParams, It as normalizeDevicePublicKeyBase64Url, J as validateNodeInvokeResultParams, K as validateNodeEventParams, L as validateExecApprovalRequestParams, Lt as verifyDeviceSignature, M as validateDevicePairApproveParams, Mt as buildDeviceAuthPayload, N as validateDevicePairListParams, O as validateCronRunParams, Ot as ErrorCodes, P as validateDevicePairRejectParams, Pt as deriveDeviceIdFromPublicKey, Q as validateNodePairRejectParams, R as validateExecApprovalResolveParams, S as validateConfigSchemaParams, St as validateWebLoginWaitParams, T as validateCronAddParams, Tt as validateWizardStartParams, U as validateLogsTailParams, V as validateExecApprovalsNodeSetParams, W as validateModelsListParams, X as validateNodePairApproveParams, Y as validateNodeListParams, Z as validateNodePairListParams, _ as validateChatInjectParams, _t as validateTalkConfigParams, a as validateAgentWaitParams, at as validateSessionsCompactParams, b as validateConfigGetParams, bt as validateWakeParams, c as validateAgentsFilesGetParams, ct as validateSessionsPatchParams, d as validateAgentsListParams, dt as validateSessionsResolveParams, et as validateNodePairVerifyParams, f as validateAgentsUpdateParams, ft as validateSessionsUsageParams, g as validateChatHistoryParams, gt as validateSkillsUpdateParams, h as validateChatAbortParams, ht as validateSkillsStatusParams, i as validateAgentParams, it as validateSendParams, j as validateCronUpdateParams, jt as parseSessionLabel, k as validateCronRunsParams, kt as errorShape, l as validateAgentsFilesListParams, lt as validateSessionsPreviewParams, m as validateChannelsStatusParams, mt as validateSkillsInstallParams, n as formatValidationErrors, nt as validatePollParams, o as validateAgentsCreateParams, ot as validateSessionsDeleteParams, p as validateChannelsLogoutParams, pt as validateSkillsBinsParams, q as validateNodeInvokeParams, r as validateAgentIdentityParams, rt as validateRequestFrame, s as validateAgentsDeleteParams, st as validateSessionsListParams, tt as validateNodeRenameParams, u as validateAgentsFilesSetParams, ut as validateSessionsResetParams, v as validateChatSendParams, vt as validateTalkModeParams, w as validateConnectParams, wt as validateWizardNextParams, x as validateConfigPatchParams, xt as validateWebLoginStartParams, y as validateConfigApplyParams, yt as validateUpdateRunParams, z as validateExecApprovalsGetParams } from "./client-Bp-CZTme.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-B_GvGC2l.js";
import { n as callGateway, o as loadGatewayTlsRuntime$1 } from "./call-Cn29hQ46.js";
import { f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-BoxkHV_q.js";
import { c as pickPrimaryLanIPv4, d as resolveGatewayListenHosts, f as resolveHostName, i as isTrustedProxyAddress, l as resolveGatewayBindHost, n as isLoopbackHost, o as normalizeHostHeader, p as rawDataToString, r as isPrivateOrLoopbackAddress, t as isLoopbackAddress, u as resolveGatewayClientIp } from "./net-BdCqGqx_.js";
import { i as normalizeInputProvenance } from "./input-provenance-DRrWAEiI.js";
import { $n as startDiagnosticHeartbeat, $t as applyModelOverrideToSessionEntry, A as createReplyDispatcher, At as consumeGatewaySigusr1RestartAuthorization, Bn as resolveTtsProviderOrder, Bt as loadProviderUsageSummary, Ct as detectSuspiciousPatterns, Dt as persistBrowserProxyFiles, Et as applyBrowserProxyPaths, Fn as isTtsProviderConfigured, Ft as scheduleGatewaySigusr1Restart, G as ensureOutboundSessionEntry, Gn as OPENAI_TTS_VOICES, H as readLatestAssistantReply, Hn as setTtsProvider, I as resolveCronStyleNow, In as resolveTtsApiKey, It as setGatewaySigusr1RestartPolicy, Jn as getTotalQueueSize, Jt as requestHeartbeatNow, K as resolveOutboundSessionRoute, Kn as getActiveTaskCount, L as getCliSessionId, Ln as resolveTtsAutoMode, Lt as setPreRestartDeferralCheck, Mn as resolveUserTimezone, Mt as emitGatewayRestart, Nn as getTtsProvider, Nt as isGatewaySigusr1RestartExternallyAllowed, On as isAbortTrigger, P as BARE_SESSION_RESET_PROMPT, Pn as isTtsEnabled, Pt as markGatewaySigusr1RestartHandled, Q as resetDirectoryCache, Qn as CommandLane, R as setCliSessionId, Rn as resolveTtsConfig, Rt as normalizeGroupActivation, St as buildSafeExternalPrompt, Tn as formatZonedTimestamp, Tt as isExternalHookSession, U as resolveAnnounceTargetFromKey, Un as textToSpeech, V as createOpenClawTools, Vn as setTtsEnabled, Wn as OPENAI_TTS_MODELS, X as resolveSessionDeliveryTarget, Xn as setCommandLaneConcurrency, Xt as normalizeSendPolicy, Y as resolveOutboundTarget, Yn as resetAllLanes, Zn as waitForActiveTasks, Zt as resolveSendPolicy, _ as readJsonBodyWithLimit, _n as extractImageContentFromSource, _t as buildDeliveryFromLegacyPayload, a as runSubagentAnnounceFlow, bn as resolveAgentTimeoutMs, c as abortEmbeddedPiRun, cn as DEFAULT_INPUT_FILE_MIMES, cr as emitAgentEvent, ct as writeRestartSentinel, d as applyToolPolicyPipeline, dn as DEFAULT_INPUT_MAX_REDIRECTS, dr as registerAgentRunContext, dt as inferLegacyName, en as applyVerboseOverride, er as stopDiagnosticHeartbeat, et as runWithModelFallback, f as buildDefaultToolPolicyPipelineSteps, fn as DEFAULT_INPUT_PDF_MAX_PAGES, ft as normalizeOptionalAgentId, g as handleSlackHttpRequest, gn as extractFileContentFromSource, gt as migrateLegacyCronPayload, h as loadOpenClawPlugins, hn as DEFAULT_INPUT_TIMEOUT_MS, ht as normalizeRequiredName, it as formatRestartSentinelMessage, j as getTotalPendingReplies, jt as deferGatewayRestartUntilIdle, k as dispatchInboundMessage, kn as stopSubagentsForRequester, l as getActiveEmbeddedRunCount, ln as DEFAULT_INPUT_IMAGE_MAX_BYTES, lr as getAgentRunContext, lt as normalizeCronJobCreate, m as getPluginToolMeta, mn as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, mt as normalizePayloadToSystemText, n as initSubagentRegistry, nn as enqueueSystemEvent, nr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, nt as consumeRestartSentinel, o as clearSessionQueues, on as DEFAULT_INPUT_FILE_MAX_BYTES, or as stripHeartbeatToken, ot as summarizeRestartSentinel, p as sniffMimeFromBase64, pn as DEFAULT_INPUT_PDF_MAX_PIXELS, pt as normalizeOptionalText, r as listDescendantRunsForRequester, rn as isSystemEventContextChanged, rt as formatDoctorNonInteractiveHint, s as runEmbeddedPiAgent, sn as DEFAULT_INPUT_FILE_MAX_CHARS, sr as clearAgentRunContext, t as countActiveDescendantRuns, tn as parseVerboseOverride, tr as isDiagnosticsEnabled, u as waitForEmbeddedPiRunEnd, un as DEFAULT_INPUT_IMAGE_MIMES, ur as onAgentEvent, ut as normalizeCronJobPatch, v as requestBodyErrorToText, vn as normalizeMimeList, vt as hasLegacyDeliveryHints, w as buildHistoryContextFromEntries, wt as getHookType, yn as estimateBase64DecodedBytes, yt as stripLegacyDeliveryFields, z as runCliAgent, zn as resolveTtsPrefsPath } from "./subagent-registry-kdTa9uwX.js";
import { C as resolveAgentMainSessionKey, E as resolveMainSessionKeyFromConfig, F as normalizeSessionDeliveryFields, N as mergeDeliveryContext, O as snapshotSessionOrigin, T as resolveMainSessionKey, i as loadSessionStore, j as deliveryContextFromSession, l as updateSessionStore, t as extractDeliveryInfo, w as resolveExplicitAgentSessionKey } from "./sessions-Cy55zv3n.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyText } from "./tokens-vdnEt1VF.js";
import "./normalize-J3mTxq-2.js";
import "./bindings-CeWP3eHN.js";
import "./logging-CfEk_PnX.js";
import "./accounts-Beq84OQo.js";
import "./send-DJZBYeK5.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-B4cKx11a.js";
import "./send-DlPIYd0T.js";
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName } from "./with-timeout-DsNXM1CO.js";
import { S as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, w as runGlobalGatewayStopSafely } from "./deliver-BRNIcAT5.js";
import "./send-duSeswNZ.js";
import { o as detectMime } from "./image-ops-DHR6894Y.js";
import "./pi-embedded-helpers-Bkf18Lss.js";
import { g as collectExplicitAllowlist, x as resolveToolProfilePolicy, y as mergeAlsoAllowPolicy } from "./sandbox-wO-1oO2k.js";
import "./chrome-BxSF3eyi.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-D7IN8dvd.js";
import { t as safeEqualSecret } from "./secret-equal-DGrTmbAZ.js";
import { a as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, i as resolveGatewayAuth, n as authorizeGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, r as isLocalDirectRequest, s as createAuthRateLimiter, t as assertGatewayAuthConfigured } from "./auth-DUKy_TmG.js";
import "./server-context-D56LKCTT.js";
import "./routes-BP-1vJKR.js";
import "./redact-C5wI7Ob4.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-CFvaLX5j.js";
import "./paths-CRRAf1k1.js";
import "./ssrf-B2Y1od3A.js";
import "./store-ZMcXdLES.js";
import { i as formatPortDiagnostics, n as inspectPortUsage, t as ensurePortAvailable } from "./ports-Bl3QRYGX.js";
import { t as movePathToTrash } from "./trash-CyQ0N--G.js";
import "./dock-CydjVxuT.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-iP6tOVPR.js";
import "./tool-images-BzK_1ySW.js";
import { a as normalizeElevatedLevel, c as normalizeUsageDisplay, d as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeReasoningLevel, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-C1OQknuZ.js";
import "./models-config-6-o1aQBU.js";
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-CVcuHH0W.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-Dwo-v-iX.js";
import "./manager-R53uMDbK.js";
import "./sqlite-DNTJEWLw.js";
import "./retry-BJxmeyhA.js";
import { t as ToolInputError } from "./common-Bl39mxj5.js";
...
import { l as registerUnhandledRejectionHandler } from "./runner-BxAR2JJ5.js";
import { n as loadModelCatalog } from "./model-catalog-CSKVVT2n.js";
import { _ as lookupContextTokens, a as loadCombinedSessionStoreForGateway, c as resolveGatewaySessionStoreTarget, d as archiveSessionTranscripts, f as capArrayByJsonBytes, g as stripEnvelopeFromMessages, h as resolveSessionTranscriptCandidates, i as listSessionsFromStore, l as resolveSessionModelRef, m as readSessionPreviewItemsFromTranscript, o as loadSessionEntry, p as readSessionMessages, r as listAgentsForGateway, s as pruneLegacyStoreKeys, t as canonicalizeSpawnedByForAgent, u as archiveFileOnDisk } from "./session-utils-DDGM3uen.js";
import { C as createAsyncLock, D as getSkillsSnapshotVersion, O as registerSkillsChangeListener, S as resolvePairingPaths, T as writeJsonAtomic, _ as updatePairedNodeMetadata, a as getRemoteSkillEligibility, b as verifyPairingToken, c as refreshRemoteBinsForConnectedNodes, d as setSkillsRemoteRegistry, f as approveNodePairing, g as requestNodePairing, h as renamePairedNode, l as refreshRemoteNodeBins, m as rejectNodePairing, o as primeRemoteSkillsCache, p as listNodePairing, s as recordRemoteNodeInfo, u as removeRemoteNodeInfo, v as verifyNodeToken, w as readJsonFile, x as pruneExpiredPending, y as generatePairingToken } from "./skill-commands-Ck6X4pqf.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-BbV1AS7m.js";
import "./pairing-store-BDgc-abf.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-B2pG38xL.js";
import "./nodes-screen-BXMpVZkZ.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-BCCZShZY.js";
...
import { t as parseAbsoluteTimeMs } from "./parse-B6Z5uj5w.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-sIhb3cYi.js";
...
import { t as getChannelActivity } from "./channel-activity-Dx2itHd7.js";
...
import { n as withProgress } from "./progress-C0Eq81ZL.js";
import "./replies-dGUYE7k3.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-Dle3hR8S.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-CQEkF4Ds.js";
import "./prompt-style-CPqouQNO.js";
import "./pairing-labels-CueqFrkf.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-aMNUABIw.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CbadW3YK.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-u9-jOGeF.js";
import { t as buildChannelUiCatalog } from "./catalog-CDobrQ6P.js";
import { t as WizardCancelledError } from "./prompts-OFJRqDDg.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-B8Dnhd32.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-TZgfni-n.js";
import "./install-safe-path-D0SETjXq.js";
import "./skill-scanner-DLxZR9YD.js";
import { t as buildChannelAccountSnapshot } from "./status-NrLv49mO.js";
...
import "./lifecycle-core-D2W3K11y.js";
import { t as parsePort$1 } from "./parse-port-DEJJlpU0.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-BJk2my4o.js";
import "./diagnostics-DjveIvle.js";
import "./service-audit-CVzwAAAG.js";
import "./table-ozIiGDit.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-Bb4W3rUg.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-Bq9goq4R.js";
import { c as probeGateway, o as isNodeCommandAllowed, s as resolveNodeCommandAllowlist } from "./audit-Dn_2xve1.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-DKQg4CZP.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-DVqZ11H_.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-BdRowCdl.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-C57eEw5y.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-YaXJozZX.js";
import { a as resolveNpmChannelTag, c as DEFAULT_PACKAGE_CHANNEL, m as normalizeUpdateChannel, n as compareSemverStrings, t as checkUpdateStatus } from "./update-check-ByQxwtzZ.js";
import { t as runOnboardingWizard } from "./onboarding-AsuVK6QL.js";
import { a as setGatewayWsLogStyle, i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-CzWfakqi.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils--za-jrLN.js";
import { a as loadAgentIdentity, c as loadAgentIdentityFromWorkspace, i as listAgentEntries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-_OjSC1Ry.js";
import { i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-ryGRIqHy.js";
import "./node-service-CexwKySz.js";
import "./status.update-C5S3-C3t.js";
import { n as validateSystemRunCommandConsistency, t as formatExecCommand } from "./system-run-command-pTlAsVFO.js";
import { t as installSkill } from "./skills-install-BURj7clD.js";
import { t as runGatewayUpdate } from "./update-runner-BLOnN6SG.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-CxUO7JST.js";
import { n as forceFreePortAndWait } from "./ports-D0vBBES0.js";
...
function shouldSkipDiscordForwarding(cfg) {
...
function createExecApprovalForwarder(deps = {}) {
	...
	const handleRequested = async (request) => {
		...
		const filteredTargets = shouldSkipDiscordForwarding(cfg) ? targets.filter((target) => normalizeMessageChannel(target.channel) !== "discord") : targets;
...
function createJob(state, input) {
	...
	const job = {
		...
		enabled,
		notify: typeof input.notify === "boolean" ? input.notify : void 0,
		deleteAfterRun,
		createdAtMs: now,
		updatedAtMs: now,
		schedule,
...
function applyJobPatch(job, patch) {
	...
	if (typeof patch.notify === "boolean") job.notify = patch.notify;
...
const MAX_BUFFERED_BYTES = 30 * 1024 * 1024;
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BnF19JYT.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-BCCZShZY.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-DmTFNFCT.js").then((n) => n.t);
...
function parseOrigin(originRaw) {
	...
	if (!trimmed || trimmed === "null" || trimmed.startsWith("file:")) return null;
	try {
...
function checkBrowserOrigin(params) {
	...
	if (!parsedOrigin) {
		const _rh = normalizeHostHeader(params.requestHost);
		if (_rh && isLoopbackHost(resolveHostName(_rh))) return { ok: true };
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-P--h9nsG.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-BRNIcAT5.js").then((n) => n.n);
