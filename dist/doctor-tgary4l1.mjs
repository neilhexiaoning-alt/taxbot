...
import { Bt as randomToken, Nt as guardCancel, Ot as applyWizardMetadata, Rt as printWizardHeader, Si as loadModelCatalog, st as loadOpenClawPlugins } from "./reply-CReGWUt7.mjs";
import { d as resolveIsNixMode, f as resolveLegacyStateDirs, g as resolveStateDir, m as resolveOAuthDir, p as resolveNewStateDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-DcBT4Q4r.mjs";
import { A as buildAgentMainSessionKey, D as DEFAULT_ACCOUNT_ID, E as resolveOpenClawPackageRoot, P as normalizeAgentId, c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, k as DEFAULT_MAIN_KEY, s as resolveAgentWorkspaceDir } from "./agent-scope-BD88ooNs.mjs";
import { V as getResolvedLoggerSettings, c as defaultRuntime } from "./subsystem-iSHcgawR.mjs";
import { _ as shortenHomePath, p as resolveHomeDir$1, v as sleep } from "./utils-D9-prTJL.mjs";
import { n as runExec, t as runCommandWithTimeout } from "./exec-BRaJtAm2.mjs";
import { $ as repairOAuthProfileIdMismatch, J as resolveApiKeyForProfile, d as resolveHooksGmailModel, dt as CLAUDE_CLI_PROFILE_ID, ft as CODEX_CLI_PROFILE_ID, ht as DEFAULT_PROVIDER, it as ensureAuthProfileStore, l as resolveConfiguredModelRef, mt as DEFAULT_MODEL, ot as updateAuthProfileStoreWithLock, q as resolveProfileUnusableUntilForDisplay, r as getModelRefStatus } from "./model-selection-DNDKru6x.mjs";
import { t as formatCliCommand } from "./command-format-CRQZQg6U.mjs";
import { t as isTruthyEnvValue } from "./env-DE0tkFHW.mjs";
import { c as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, u as OpenClawSchema } from "./config-B_uz17RB.mjs";
import { n as listChannelPlugins } from "./plugins-DSII6JvY.mjs";
import { Dt as DEFAULT_SANDBOX_BROWSER_IMAGE, L as resolveMainSessionKey, Ot as DEFAULT_SANDBOX_COMMON_IMAGE, P as canonicalizeMainSessionAlias, d as loadSessionStore, kt as DEFAULT_SANDBOX_IMAGE, m as saveSessionStore, vt as resolveSandboxScope } from "./sandbox-oRz8OYlY.mjs";
import { d as inspectPortUsage, p as formatPortDiagnostics } from "./chrome-PKn2zNTL.mjs";
import { a as resolveSessionTranscriptsDirForAgent, n as resolveSessionFilePath, o as resolveStorePath } from "./paths-D0n0xdZb.mjs";
import { n as isWSL, r as isWSLEnv } from "./dispatcher-CWBZae0H.mjs";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-DrwxBANw.mjs";
import { i as readChannelAllowFromStore } from "./pairing-store-bEGBKxWn.mjs";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DXmBJpDK.mjs";
import { d as resolveGatewaySystemdServiceName, f as resolveGatewayWindowsTaskName, l as resolveGatewayLaunchAgentLabel, m as resolveNodeLaunchAgentLabel } from "./constants-z8aDT2bn.mjs";
...
import { t as note$1 } from "./note-COgvwFa3.mjs";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DtZr53tO.mjs";
import { i as healthCommand, t as formatHealthCheckFailure } from "./health-format-CQglK8Ez.mjs";
import { t as runGatewayUpdate } from "./update-runner-Dy5Zj6kW.mjs";
import { a as resolveGatewayBindHost, n as isLoopbackHost } from "./net-Bbs_dfMf.mjs";
import { i as resolveGatewayAuth } from "./auth-CKLbBArb.mjs";
import { t as buildWorkspaceSkillStatus } from "./skills-status-B4i4oPU3.mjs";
import { a as repairLaunchAgentBootstrap, i as launchAgentPlistExists, n as isLaunchAgentListed, o as resolveGatewayLogPaths, r as isLaunchAgentLoaded, t as resolveGatewayService } from "./service-DhHo4Mch.mjs";
import { r as isSystemdUserServiceAvailable } from "./systemd-UR47hdt4.mjs";
import { a as renderGatewayServiceCleanupHints, i as findExtraGatewayServices, n as auditGatewayServiceConfig, o as readLastGatewayErrorLine, r as needsNodeRuntimeMigration, t as SERVICE_AUDIT_CODES } from "./service-audit-Cvhsjyh8.mjs";
import { t as collectChannelStatusIssues } from "./channels-status-issues-WMEemfar.mjs";
import { a as gatewayInstallErrorHint, d as renderSystemNodeWarning, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, p as resolveSystemNodeInfo, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-B-EHQzP_.mjs";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DSqFRbzY.mjs";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DsWyh-I_.mjs";
import { n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail } from "./systemd-hints-BoHV6nKj.mjs";
