...
import { n as resolveAgentConfig, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-BD88ooNs.mjs";
import { t as createSubsystemLogger } from "./subsystem-iSHcgawR.mjs";
import { h as resolveUserPath, i as clampNumber$1, r as clampInt, v as sleep, x as truncateUtf16Safe } from "./utils-D9-prTJL.mjs";
import { M as resolveApiKeyForProvider, j as requireApiKey } from "./model-selection-DNDKru6x.mjs";
import { t as isTruthyEnvValue } from "./env-DE0tkFHW.mjs";
import { a as resolveSessionTranscriptsDirForAgent } from "./paths-D0n0xdZb.mjs";
import { n as onSessionTranscriptUpdate } from "./transcript-events-Na52iT-B.mjs";
import { a as ensureDir, c as listMemoryFiles, i as cosineSimilarity, l as normalizeExtraMemoryPaths, n as buildFileEntry, o as hashText, r as chunkMarkdown, s as isMemoryPath, t as requireNodeSqlite, u as parseEmbedding } from "./sqlite-CG_dxLw3.mjs";
...
var MemoryIndexManager = class MemoryIndexManager {
	...
	async indexFile(entry, options) {
		const chunks = chunkMarkdown(options.content ?? await fsPromises.readFile(entry.absPath, "utf-8"), this.settings.chunking).filter((chunk) => chunk.text.trim().length > 0);
