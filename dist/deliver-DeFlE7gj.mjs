...
import { i as isMessagingToolDuplicate } from "./pi-embedded-helpers-DIV_C5J8.mjs";
import { N as normalizeAccountId$1 } from "./agent-scope-BD88ooNs.mjs";
import { A as logVerbose, C as getActivePluginRegistry, N as shouldLogVerbose } from "./subsystem-iSHcgawR.mjs";
...
import { V as getChannelDock, dt as resolveSignalAccount, l as appendAssistantMessageToSessionTranscript, u as resolveMirroredTranscriptText } from "./sandbox-oRz8OYlY.mjs";
import { C as resolvePinnedHostname, S as createPinnedDispatcher, a as optimizeImageToPng, d as extensionForMime, i as hasAlphaChannel, l as saveMediaBuffer, n as convertHeicToJpeg, o as resizeToJpeg, u as detectMime, v as maxBytesForKind, w as resolvePinnedHostnameWithPolicy, x as closeDispatcher, y as mediaKindFromMime } from "./routes-2qU-Bliw.mjs";
import { t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-Ls7G_LaM.mjs";
...
async function loadWebMediaInternal(mediaUrl, options = {}) {
	...
	const data = await fsPromises.readFile(mediaUrl);
