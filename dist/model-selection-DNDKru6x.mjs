...
import { g as resolveStateDir, h as resolveOAuthPath } from "./paths-DcBT4Q4r.mjs";
import { O as DEFAULT_AGENT_ID, a as resolveAgentModelPrimary } from "./agent-scope-BD88ooNs.mjs";
import { t as createSubsystemLogger } from "./subsystem-iSHcgawR.mjs";
import { h as resolveUserPath } from "./utils-D9-prTJL.mjs";
import { a as saveJsonFile, i as loadJsonFile, r as resolveCopilotApiToken, t as DEFAULT_COPILOT_API_BASE_URL } from "./github-copilot-token-CewhQpWC.mjs";
...
//#endregion
export { repairOAuthProfileIdMismatch as $, getCustomProviderApiKey as A, shouldDeferShellEnvFallback as B, VENICE_MODEL_CATALOG as C, SYNTHETIC_MODEL_CATALOG as D, SYNTHETIC_DEFAULT_MODEL_REF as E, resolveModelAuthMode as F, markAuthProfileFailure as G, auth_profiles_exports as H, getShellEnvAppliedKeys as I, resolveApiKeyForProfile as J, markAuthProfileUsed as K, getShellPathFromLoginShell as L, resolveApiKeyForProvider as M, resolveAwsSdkEnvVarName as N, buildSyntheticModelDefinition as O, resolveEnvApiKey as P, parseOAuthCallbackInput as Q, loadShellEnvFallback as R, VENICE_DEFAULT_MODEL_REF as S, SYNTHETIC_BASE_URL as T, resolveAuthProfileOrder as U, shouldEnableShellEnvFallback as V, isProfileInCooldown as W, exchangeChutesCodeForTokens as X, CHUTES_AUTHORIZE_ENDPOINT as Y, generateChutesPkce as Z, normalizeProviders as _, modelKey as a, loadAuthProfileStore as at, resolveImplicitProviders as b, resolveAllowedModelRef as c, resolveAuthStorePathForDisplay as ct, resolveHooksGmailModel as d, CLAUDE_CLI_PROFILE_ID as dt, listProfilesForProvider as et, resolveModelRefFromString as f, CODEX_CLI_PROFILE_ID as ft, normalizeGoogleModelId as g, buildXiaomiProvider as h, DEFAULT_PROVIDER as ht, isCliProvider as i, ensureAuthProfileStore as it, requireApiKey as j, getApiKeyForModel as k, resolveConfiguredModelRef as l, resolveOpenClawAgentDir as lt, XIAOMI_DEFAULT_MODEL_ID as m, DEFAULT_MODEL as mt, buildModelAliasIndex as n, setAuthProfileOrder as nt, normalizeProviderId as o, updateAuthProfileStoreWithLock as ot, resolveThinkingDefault as p, DEFAULT_CONTEXT_TOKENS as pt, resolveProfileUnusableUntilForDisplay as q, getModelRefStatus as r, upsertAuthProfile as rt, parseModelRef as s, resolveAuthStorePath as st, buildAllowedModelSet as t, markAuthProfileGood as tt, resolveDefaultModelForAgent as u, resolveAuthProfileDisplayLabel as ut, resolveImplicitBedrockProvider as v, buildVeniceModelDefinition as w, VENICE_BASE_URL as x, resolveImplicitCopilotProvider as y, resolveShellEnvFallbackTimeoutMs as z };