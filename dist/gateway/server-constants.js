export const MAX_PAYLOAD_BYTES = 25 * 1024 * 1024; // cap incoming frame size (25 MB for image attachments)
export const MAX_BUFFERED_BYTES = 30 * 1024 * 1024; // per-connection send buffer limit
