    ...
    "chat.send": async ({ params, respond, context, client }) => {
        ...
        try {
            ...
            if (attCount > 0) {
                ...
                const sampleInfo = {
                    ...
                    contentPreviewLength: typeof sample?.content === "string" ? sample.content.length : undefined,
                };
        ...
        try {
            ...
            try {
                ...
                context.logGateway?.info?.(`dispatchInboundMessage: passing images=${imgCount}, documents=${docCount}` +
