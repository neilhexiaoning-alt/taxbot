import { $t as getRemoteSkillEligibility, At as detectBrowserOpenSupport, Bt as randomToken, Dt as DEFAULT_WORKSPACE, It as normalizeGatewayTokenInput, Lt as openUrl, Mt as formatControlUiSshHint, Ot as applyWizardMetadata, Pt as handleReset, Rt as printWizardHeader, Ut as summarizeExistingConfig, Vt as resolveControlUiLinks, Wt as waitForGatewayReachable, ct as loadProviderUsageSummary, jt as ensureWorkspaceAndSessions, kr as getMemorySearchManager, lt as formatUsageReportLines, mi as lookupContextTokens, qt as normalizeControlUiBasePath, v as listAgentsForGateway, xi as peekSystemEvents, zt as probeGatewayReachable } from "./reply-CReGWUt7.mjs";
import { n as DEFAULT_GATEWAY_PORT, u as resolveGatewayPort } from "./paths-DcBT4Q4r.mjs";
import { E as resolveOpenClawPackageRoot, P as normalizeAgentId, U as parseAgentSessionKey, c as resolveDefaultAgentId, h as DEFAULT_IDENTITY_FILENAME, p as DEFAULT_BOOTSTRAP_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-BD88ooNs.mjs";
import { D as info, L as isRich, R as theme, c as defaultRuntime, l as restoreTerminalState } from "./subsystem-iSHcgawR.mjs";
import { h as resolveUserPath } from "./utils-D9-prTJL.mjs";
import { n as runExec } from "./exec-BRaJtAm2.mjs";
import { ht as DEFAULT_PROVIDER, it as ensureAuthProfileStore, l as resolveConfiguredModelRef, mt as DEFAULT_MODEL, pt as DEFAULT_CONTEXT_TOKENS } from "./model-selection-DNDKru6x.mjs";
import { t as formatCliCommand } from "./command-format-CRQZQg6U.mjs";
import { J as VERSION, c as writeConfigFile, i as loadConfig, o as readConfigFileSnapshot } from "./config-B_uz17RB.mjs";
import { n as listChannelPlugins } from "./plugins-DSII6JvY.mjs";
import { L as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-oRz8OYlY.mjs";
import { d as inspectPortUsage, p as formatPortDiagnostics } from "./chrome-PKn2zNTL.mjs";
import { o as resolveStorePath } from "./paths-D0n0xdZb.mjs";
import { t as buildChannelSummary } from "./channel-summary-CADwe6FA.mjs";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-DrwxBANw.mjs";
import { n as withProgress } from "./progress-BYrleoMX.mjs";
import { a as summarizeRestartSentinel, i as readRestartSentinel } from "./restart-sentinel-BSJCs5vQ.mjs";
import { a as findTailscaleBinary, o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-4Z5W8e4e.mjs";
import { n as resolveChannelDefaultAccountId } from "./helpers--sAxmx1H.mjs";
import { n as logConfigUpdated } from "./logging-BTIZSnJm.mjs";
import { t as WizardCancelledError } from "./prompts-TEa_gmaq.mjs";
import { c as promptDefaultModel, d as resolvePreferredProviderForAuthChoice, f as warnIfModelConfigLooksOff, g as promptAuthChoiceGrouped, p as applyAuthChoice, r as promptRemoteGatewayConfig, s as applyPrimaryModel, t as setupSkills, u as ensureControlUiAssetsBuilt } from "./onboard-skills-CJmeZwSj.mjs";
import { n as setupChannels } from "./onboard-channels-B7Nzchqn.mjs";
import { a as resolveHeartbeatSummaryForAgent, i as healthCommand, n as formatHealthChannelLines, t as formatHealthCheckFailure } from "./health-format-CQglK8Ez.mjs";
import { c as compareSemverStrings, g as resolveEffectiveUpdateChannel, h as normalizeUpdateChannel, m as formatUpdateChannelLabel, s as checkUpdateStatus } from "./update-runner-Dy5Zj6kW.mjs";
import { i as probeGateway, t as runSecurityAudit } from "./audit-DMnpd9wB.mjs";
import { t as renderTable } from "./table-DWsrGl_1.mjs";
import { t as buildWorkspaceSkillStatus } from "./skills-status-B4i4oPU3.mjs";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-DhHo4Mch.mjs";
import { r as isSystemdUserServiceAvailable } from "./systemd-UR47hdt4.mjs";
import { o as readLastGatewayErrorLine } from "./service-audit-Cvhsjyh8.mjs";
import { t as resolveNodeService } from "./node-service-CSOsuHIp.mjs";
import { t as collectChannelStatusIssues } from "./channels-status-issues-WMEemfar.mjs";
import { i as redactSecrets, n as formatDuration$1, r as formatGatewayAuthUsed, t as formatAge$1 } from "./format-X1Pej5dy.mjs";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-DcPF_ckr.mjs";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-B-EHQzP_.mjs";
import { t as buildWorkspaceHookStatus } from "./hooks-status-DeeGK9W4.mjs";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DSqFRbzY.mjs").then((n) => n.r);
...
//#endregion
export { buildAgentSummaries as a, loadAgentIdentity as c, loadAgentIdentityFromWorkspace as d, parseIdentityMarkdown as f, applyAgentConfig as i, pruneAgentConfig as l, statusCommand as n, findAgentEntryIndex as o, getStatusSummary as r, listAgentEntries as s, runOnboardingWizard as t, identityHasValues as u };