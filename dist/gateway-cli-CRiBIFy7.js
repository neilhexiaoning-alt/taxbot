...
import { $ as deferGatewayRestartUntilIdle, $n as isDiagnosticsEnabled, A as pruneLegacyStoreKeys, An as resolveUserTimezone, At as getPluginToolMeta, Bn as setTtsProvider, Bt as readJsonBodyWithLimit, C as resolveAnnounceTargetFromKey, Cr as DEFAULT_INPUT_TIMEOUT_MS, Ct as stripLegacyDeliveryFields, D as listSessionsFromStore, Dn as getAgentRunContext, Dr as estimateBase64DecodedBytes, Dt as persistBrowserProxyFiles, E as listAgentsForGateway, En as emitAgentEvent, Er as normalizeMimeList, Et as applyBrowserProxyPaths, F as capArrayByJsonBytes, Fn as resolveTtsAutoMode, G as resolveOutboundTarget, Gt as detectSuspiciousPatterns, H as resolveOutboundSessionRoute, Hn as OPENAI_TTS_MODELS, I as readSessionMessages, In as resolveTtsConfig, J as resetDirectoryCache, Jn as setCommandLaneConcurrency, K as resolveSessionDeliveryTarget, Kn as getTotalQueueSize, Kt as getHookType, L as readSessionPreviewItemsFromTranscript, Ln as resolveTtsPrefsPath, M as resolveSessionModelRef, Mn as isTtsEnabled, Mt as normalizeGroupActivation, N as archiveFileOnDisk, Nn as isTtsProviderConfigured, O as loadCombinedSessionStoreForGateway, On as onAgentEvent, Or as resolveAgentTimeoutMs, Ot as requestHeartbeatNow, P as archiveSessionTranscripts, Pn as resolveTtsApiKey, Pt as loadProviderUsageSummary, Q as consumeGatewaySigusr1RestartAuthorization, Qn as stopDiagnosticHeartbeat, R as resolveSessionTranscriptCandidates, Rn as resolveTtsProviderOrder, S as createOpenClawTools, Sn as readLatestAssistantReply, Sr as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, St as hasLegacyDeliveryHints, Tn as clearAgentRunContext, Tr as extractImageContentFromSource, Un as OPENAI_TTS_VOICES, V as ensureOutboundSessionEntry, Vn as textToSpeech, Vt as requestBodyErrorToText, Wn as getActiveTaskCount, Wt as buildSafeExternalPrompt, X as runWithModelFallback, Xn as CommandLane, Yn as waitForActiveTasks, Zn as startDiagnosticHeartbeat, Zt as buildHistoryContextFromEntries, _ as waitForEmbeddedPiRunEnd, _n as countActiveDescendantRuns, _r as DEFAULT_INPUT_IMAGE_MAX_BYTES, _t as normalizeOptionalText, a as getCliSessionId, ar as lookupContextTokens, at as setPreRestartDeferralCheck, b as buildDefaultToolPolicyPipelineSteps, br as DEFAULT_INPUT_PDF_MAX_PAGES, bt as migrateLegacyCronPayload, cr as applyVerboseOverride, ct as formatRestartSentinelMessage, d as normalizeSendPolicy, dr as isSystemEventContextChanged, er as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, et as emitGatewayRestart, f as resolveSendPolicy, ft as writeRestartSentinel, g as getActiveEmbeddedRunCount, gr as DEFAULT_INPUT_FILE_MIMES, gt as normalizeOptionalAgentId, h as abortEmbeddedPiRun, hr as DEFAULT_INPUT_FILE_MAX_CHARS, ht as inferLegacyName, i as resolveCronStyleNow, in as getTotalPendingReplies, ir as stripHeartbeatToken, it as setGatewaySigusr1RestartPolicy, j as resolveGatewaySessionStoreTarget, jn as getTtsProvider, jt as loadOpenClawPlugins, k as loadSessionEntry, kn as registerAgentRunContext, lr as parseVerboseOverride, m as runEmbeddedPiAgent, mn as stopSubagentsForRequester, mr as DEFAULT_INPUT_FILE_MAX_BYTES, mt as normalizeCronJobPatch, n as BARE_SESSION_RESET_PROMPT, nn as dispatchInboundMessage, nt as markGatewaySigusr1RestartHandled, o as setCliSessionId, ot as consumeRestartSentinel, p as clearSessionQueues, pn as isAbortTrigger, pt as normalizeCronJobCreate, qn as resetAllLanes, qt as isExternalHookSession, rn as createReplyDispatcher, rt as scheduleGatewaySigusr1Restart, s as runCliAgent, sr as applyModelOverrideToSessionEntry, st as formatDoctorNonInteractiveHint, tt as isGatewaySigusr1RestartExternallyAllowed, un as formatZonedTimestamp, ur as enqueueSystemEvent, ut as summarizeRestartSentinel, vn as initSubagentRegistry, vr as DEFAULT_INPUT_IMAGE_MIMES, vt as normalizePayloadToSystemText, w as canonicalizeSpawnedByForAgent, wr as extractFileContentFromSource, x as sniffMimeFromBase64, xn as runSubagentAnnounceFlow, xr as DEFAULT_INPUT_PDF_MAX_PIXELS, xt as buildDeliveryFromLegacyPayload, y as applyToolPolicyPipeline, yn as listDescendantRunsForRequester, yr as DEFAULT_INPUT_MAX_REDIRECTS, yt as normalizeRequiredName, z as stripEnvelopeFromMessages, zn as setTtsEnabled, zt as handleSlackHttpRequest } from "./reply-B1AnbNl6.js";
...
import { a as setConsoleSubsystemFilter, f as defaultRuntime, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger } from "./subsystem-CiM1FVu6.js";
import { i as logDebug, n as runExec, s as logWarn, t as runCommandWithTimeout } from "./exec-DSVXqxGa.js";
import { D as resolveWorkspaceTemplateDir, E as resolveDefaultAgentWorkspaceDir, S as ensureAgentWorkspace, _ as DEFAULT_MEMORY_ALT_FILENAME, b as DEFAULT_TOOLS_FILENAME, c as resolveDefaultAgentId, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, i as resolveAgentModelFallbacksOverride, m as DEFAULT_BOOTSTRAP_FILENAME, n as resolveAgentConfig, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, u as resolveSessionAgentId, v as DEFAULT_MEMORY_FILENAME, w as isWorkspaceOnboardingCompleted, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./agent-scope-5j4KiZmG.js";
import { Lt as DEFAULT_CONTEXT_TOKENS, Nt as normalizeSecretInput, Rt as DEFAULT_MODEL, a as isCliProvider, f as resolveConfiguredModelRef, g as resolveThinkingDefault, i as getModelRefStatus, jt as isPidAlive, m as resolveHooksGmailModel, p as resolveDefaultModelForAgent, u as resolveAllowedModelRef, zt as DEFAULT_PROVIDER } from "./model-selection-DnrWKBOM.js";
import "./github-copilot-token-D2zp6kMZ.js";
import { t as formatCliCommand } from "./command-format-DEKzLnLg.js";
import "./boolean-BsqeuxE6.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-DRL0O4y1.js";
...
import { l as registerUnhandledRejectionHandler } from "./runner-BBNVS4uo.js";
...
import { g as collectExplicitAllowlist, x as resolveToolProfilePolicy, y as mergeAlsoAllowPolicy } from "./sandbox-CCXqNFNa.js";
import "./chrome-CZ4H3suC.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-DOI5fbGP.js";
...
import { a as isTrustedProxyAddress, d as resolveGatewayClientIp, f as resolveGatewayListenHosts, i as isPrivateOrLoopbackAddress, l as pickPrimaryLanIPv4, n as isLoopbackAddress, p as resolveHostName, r as isLoopbackHost, s as normalizeHostHeader, t as rawDataToString, u as resolveGatewayBindHost } from "./ws-DkKfG5o3.js";
import { a as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, i as resolveGatewayAuth, n as authorizeGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, r as isLocalDirectRequest, s as createAuthRateLimiter, t as assertGatewayAuthConfigured } from "./auth-CN3K_86O.js";
import "./server-context-Dx2Suq6r.js";
import { l as hasBinary } from "./frontmatter-CjCfqPvH.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-Bme2RWJt.js";
...
import { o as detectMime } from "./image-ops-Dmx5NOjU.js";
import "./store-Dtv6xckJ.js";
import { a as inspectPortUsage, r as ensurePortAvailable, s as formatPortDiagnostics } from "./ports-CyKvUwdk.js";
import { t as movePathToTrash } from "./trash-CXJgiRwI.js";
...
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-CS8MdUIx.js";
...
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyText } from "./tokens-DH4MwODN.js";
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName } from "./with-timeout-D02ZTcNS.js";
import { S as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, w as runGlobalGatewayStopSafely } from "./deliver-MzjBKeOi.js";
import "./send-C7k84fkX.js";
import "./model-DO6y7gYr.js";
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-B3HwXbd2.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-34wXZGhd.js";
import "./manager-czpk57iz.js";
import "./sqlite-BC7KQnZb.js";
import "./retry-BJemoUJU.js";
import { t as ToolInputError } from "./common-C4A6CsYx.js";
...
import { C as createAsyncLock, D as getSkillsSnapshotVersion, O as registerSkillsChangeListener, S as resolvePairingPaths, T as writeJsonAtomic, _ as updatePairedNodeMetadata, a as getRemoteSkillEligibility, b as verifyPairingToken, c as refreshRemoteBinsForConnectedNodes, d as setSkillsRemoteRegistry, f as approveNodePairing, g as requestNodePairing, h as renamePairedNode, l as refreshRemoteNodeBins, m as rejectNodePairing, o as primeRemoteSkillsCache, p as listNodePairing, s as recordRemoteNodeInfo, u as removeRemoteNodeInfo, v as verifyNodeToken, w as readJsonFile, x as pruneExpiredPending, y as generatePairingToken } from "./skill-commands-CETjctyN.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-JzAjnGf0.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-CIbLFTDH.js";
import "./send-BOUjI9we.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-vhMfSJom.js";
import "./prompt-style-BAr7Tkma.js";
import "./outbound-attachment-D1NyWD1B.js";
import "./pairing-labels-97H61XdG.js";
import { i as loadSessionUsageTimeSeries, l as deriveSessionTotalTokens, n as loadCostUsageSummary, r as loadSessionCostSummary, t as discoverAllSessions, u as hasNonzeroUsage } from "./session-cost-usage-DeNCxeDS.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-BxjB8vcE.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-BgM-97-O.js";
import "./nodes-screen-Cl6H3i9t.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-DOvxvD37.js";
import { t as parseAbsoluteTimeMs } from "./parse-ZtMy_Ytv.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-B5Ud2Fxf.js";
...
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-BS2Te0AD.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Dt25E7hH.js";
import { t as forceFreePortAndWait } from "./ports-DRQYus6G.js";
import { t as buildChannelUiCatalog } from "./catalog-DEiFlBqg.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-D-5tXP1x.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-DDkIucG0.js";
import { t as WizardCancelledError } from "./prompts-DbHSz44H.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-D740RiNj.js";
...
import "./lifecycle-core-9dCStTQH.js";
import { t as parsePort$1 } from "./parse-port-M1LW5BLv.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-DaaXGjCU.js";
import "./diagnostics-9GqfwHHx.js";
import "./service-audit-BkqZyPxl.js";
import "./table-CMnhkPVz.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-CeT30EOQ.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-DGIGIUgq.js";
import { c as probeGateway, o as isNodeCommandAllowed, s as resolveNodeCommandAllowlist } from "./audit-BoGJtWj6.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-ZJFnjz2r.js";
import { n as getStatusSummary, r as pickGatewaySelfPresence } from "./status-CwxEeZ5W.js";
import { c as startHeartbeatRunner, i as styleHealthChannelLine, n as getHealthSnapshot, o as runHeartbeatOnce, s as setHeartbeatsEnabled, t as formatHealthChannelLines } from "./health-UGlyqH-a.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-C-6LraM9.js";
import { a as resolveNpmChannelTag, c as DEFAULT_PACKAGE_CHANNEL, m as normalizeUpdateChannel, n as compareSemverStrings, t as checkUpdateStatus } from "./update-check-C7IX-bKh.js";
import { t as runOnboardingWizard } from "./onboarding-Dn9VCalp.js";
import { a as setGatewayWsLogStyle, i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-DgSfdtUr.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-v6e0HKT8.js";
import { t as createOutboundSendDeps$1 } from "./outbound-send-deps-BQ7kE82R.js";
import { a as loadAgentIdentity, c as loadAgentIdentityFromWorkspace, i as listAgentEntries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-j1j1hGhL.js";
import { i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-BhJ-_m_D.js";
...
import { t as installSkill } from "./skills-install-DTGVkjra.js";
import { t as runGatewayUpdate } from "./update-runner-CT94qw71.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-CxkNG9EM.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BS24-RRg.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-DeNCxeDS.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-DOvxvD37.js").then((n) => n.t);
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-CrOjNqb8.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-MzjBKeOi.js").then((n) => n.n);
