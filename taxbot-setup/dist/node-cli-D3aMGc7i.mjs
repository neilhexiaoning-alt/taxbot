import { d as resolveIsNixMode, g as resolveStateDir } from "./paths-DcBT4Q4r.mjs";
import { n as resolveAgentConfig } from "./agent-scope-BD88ooNs.mjs";
import { I as colorize, L as isRich, R as theme, c as defaultRuntime } from "./subsystem-iSHcgawR.mjs";
...
import { J as VERSION, i as loadConfig } from "./config-B_uz17RB.mjs";
import "./manifest-registry-BADIO_87.mjs";
import "./chrome-PKn2zNTL.mjs";
import { u as detectMime } from "./routes-2qU-Bliw.mjs";
import { i as resolveBrowserConfig } from "./server-context-CAvvAxGZ.mjs";
import { m as GATEWAY_CLIENT_NAMES, p as GATEWAY_CLIENT_MODES } from "./message-channel-Ls7G_LaM.mjs";
import "./logging-sIVJ3oF8.mjs";
import { i as getMachineDisplayName, n as isWSL, t as createBrowserRouteDispatcher } from "./dispatcher-CWBZae0H.mjs";
import { At as loadOrCreateDeviceIdentity, t as GatewayClient } from "./client-DgdwkhIS.mjs";
import { t as formatDocsLink } from "./links-DX7cRSHU.mjs";
import { a as evaluateShellAllowlist, c as normalizeExecApprovals, d as requiresExecApproval, f as resolveExecApprovals, g as saveExecApprovals, h as resolveSafeBins, i as evaluateExecAllowlist, l as readExecApprovalsSnapshot, m as resolveExecApprovalsSocketPath, n as analyzeArgvCommand, r as ensureExecApprovals, t as addAllowlistEntry, u as recordAllowlistUse } from "./exec-approvals-hhzj9sO5.mjs";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-tDwWDpUV.mjs";
import { c as formatNodeServiceDescription, g as resolveNodeWindowsTaskName, h as resolveNodeSystemdServiceName, m as resolveNodeLaunchAgentLabel } from "./constants-z8aDT2bn.mjs";
import { t as ensureOpenClawCliOnPath } from "./path-env-AOlAvuGZ.mjs";
import { o as resolveGatewayLogPaths } from "./service-DhHo4Mch.mjs";
...
import { d as renderSystemNodeWarning, f as resolvePreferredNodePath, h as resolveNodeProgramArguments, o as resolveGatewayDevMode, p as resolveSystemNodeInfo, r as isGatewayDaemonRuntime, s as buildNodeServiceEnvironment, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-B-EHQzP_.mjs";
import { n as renderSystemdUnavailableHints } from "./systemd-hints-BoHV6nKj.mjs";
import { d as createNullWriter, f as emitDaemonActionJson, i as parsePort, n as formatRuntimeStatus, u as buildDaemonServiceSnapshot } from "./shared-BNu45Bke.mjs";
