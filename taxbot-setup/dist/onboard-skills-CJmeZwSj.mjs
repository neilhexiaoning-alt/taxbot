import { Ht as resolveNodeManagerOptions, Lt as openUrl, Si as loadModelCatalog, kt as detectBinary } from "./reply-CReGWUt7.mjs";
import { E as resolveOpenClawPackageRoot, a as resolveAgentModelPrimary, c as resolveDefaultAgentId, r as resolveAgentDir, s as resolveAgentWorkspaceDir, w as resolveDefaultAgentWorkspaceDir } from "./agent-scope-BD88ooNs.mjs";
import { c as defaultRuntime } from "./subsystem-iSHcgawR.mjs";
import { f as resolveConfigDir, h as resolveUserPath, s as ensureDir, t as CONFIG_DIR } from "./utils-D9-prTJL.mjs";
import { t as runCommandWithTimeout } from "./exec-BRaJtAm2.mjs";
import { A as getCustomProviderApiKey, E as SYNTHETIC_DEFAULT_MODEL_REF, P as resolveEnvApiKey, Q as parseOAuthCallbackInput, S as VENICE_DEFAULT_MODEL_REF, U as resolveAuthProfileOrder, X as exchangeChutesCodeForTokens, Y as CHUTES_AUTHORIZE_ENDPOINT, Z as generateChutesPkce, a as modelKey, et as listProfilesForProvider, ht as DEFAULT_PROVIDER, it as ensureAuthProfileStore, l as resolveConfiguredModelRef, lt as resolveOpenClawAgentDir, mt as DEFAULT_MODEL, n as buildModelAliasIndex, o as normalizeProviderId, rt as upsertAuthProfile, t as buildAllowedModelSet } from "./model-selection-DNDKru6x.mjs";
import { t as formatCliCommand } from "./command-format-CRQZQg6U.mjs";
import { g as resolveSkillKey, i as loadWorkspaceSkillEntries, t as resolveSkillsInstallPreferences, u as hasBinary } from "./skills-Cb4fWMT0.mjs";
import { X as fetchWithSsrFGuard } from "./deliver-DeFlE7gj.mjs";
import { t as resolveBrewExecutable } from "./brew-CuYkMN6_.mjs";
import { $ as buildTokenProfileId, A as applyVercelAiGatewayProviderConfig, B as setAnthropicApiKey, C as applyOpenrouterConfig, D as applyVeniceConfig, E as applySyntheticProviderConfig, F as MOONSHOT_DEFAULT_MODEL_REF, G as setOpencodeZenApiKey, H as setKimiCodingApiKey, I as OPENROUTER_DEFAULT_MODEL_REF, J as setVeniceApiKey, K as setOpenrouterApiKey, L as VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF, M as applyXiaomiProviderConfig, N as applyZaiConfig, O as applyVeniceProviderConfig, P as KIMI_CODING_MODEL_REF, Q as writeOAuthCredentials, R as XIAOMI_DEFAULT_MODEL_REF, S as applyMoonshotProviderConfig, T as applySyntheticConfig, U as setMinimaxApiKey, V as setGeminiApiKey, W as setMoonshotApiKey, X as setXiaomiApiKey, Y as setVercelAiGatewayApiKey, Z as setZaiApiKey, _ as applyMinimaxProviderConfig, b as applyKimiCodeProviderConfig, d as resolvePluginProviders, et as validateAnthropicSetupToken, f as applyOpencodeZenConfig, g as applyMinimaxConfig, h as applyMinimaxApiProviderConfig, i as formatTokenK, j as applyXiaomiConfig, k as applyVercelAiGatewayConfig, l as createVpsAwareOAuthHandlers, m as applyMinimaxApiConfig, p as applyOpencodeZenProviderConfig, q as setSyntheticApiKey, t as githubCopilotLoginCommand, u as isRemoteEnvironment, v as applyAuthProfileConfig, w as applyOpenrouterProviderConfig, x as applyMoonshotConfig, y as applyKimiCodeConfig, z as ZAI_DEFAULT_MODEL_REF } from "./github-copilot-auth-DLp_veWW.mjs";
import { a as enablePluginInConfig } from "./onboard-channels-B7Nzchqn.mjs";
import { t as buildWorkspaceSkillStatus } from "./skills-status-B4i4oPU3.mjs";
import { n as resolveWideAreaDiscoveryDomain } from "./widearea-dns-B2Uy-h8T.mjs";
...
//#endregion
export { applyModelAllowlist as a, promptDefaultModel as c, resolvePreferredProviderForAuthChoice as d, warnIfModelConfigLooksOff as f, promptAuthChoiceGrouped as g, applyGoogleGeminiModelDefault as h, discoverGatewayBeacons as i, promptModelAllowlist as l, upsertSharedEnvVar as m, installSkill as n, applyModelFallbacksFromSelection as o, applyAuthChoice as p, promptRemoteGatewayConfig as r, applyPrimaryModel as s, setupSkills as t, ensureControlUiAssetsBuilt as u };