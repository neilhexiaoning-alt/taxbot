...
import { O as DEFAULT_AGENT_ID, P as normalizeAgentId, c as resolveDefaultAgentId, s as resolveAgentWorkspaceDir } from "./agent-scope-BD88ooNs.mjs";
import { S as normalizeChatChannelId, p as CHANNEL_IDS } from "./subsystem-iSHcgawR.mjs";
import { h as resolveUserPath } from "./utils-D9-prTJL.mjs";
import { B as shouldDeferShellEnvFallback, R as loadShellEnvFallback, V as shouldEnableShellEnvFallback, pt as DEFAULT_CONTEXT_TOKENS, s as parseModelRef, z as resolveShellEnvFallbackTimeoutMs } from "./model-selection-DNDKru6x.mjs";
import { c as resolveEnableState, l as resolveMemorySlotDecision, s as normalizePluginsConfig, t as loadPluginManifestRegistry } from "./manifest-registry-BADIO_87.mjs";
...
const VERSION = typeof __OPENCLAW_VERSION__ === "string" && __OPENCLAW_VERSION__ || process.env.OPENCLAW_BUNDLED_VERSION || readVersionFromPackageJson() || "0.0.0";
...
//#endregion
export { requireOpenAllowFrom as A, setConfigValueAtPath as B, BlockStreamingCoalesceSchema as C, MarkdownConfigSchema as D, GroupPolicySchema as E, resetConfigOverrides as F, collectConfigEnvVars as G, applyLegacyMigrations as H, setConfigOverride as I, VERSION as J, resolveAgentMaxConcurrent as K, unsetConfigOverride as L, parseDurationMs as M, validateJsonSchemaValue as N, MarkdownTableModeSchema as O, getConfigOverrides as P, getConfigValueAtPath as R, ToolPolicySchema as S, DmPolicySchema as T, INCLUDE_KEY as U, unsetConfigValueAtPath as V, MAX_INCLUDE_DEPTH as W, SlackConfigSchema as _, parseConfigJson5 as a, normalizeTelegramCommandName as b, writeConfigFile as c, WhatsAppConfigSchema as d, DiscordConfigSchema as f, SignalConfigSchema as g, MSTeamsConfigSchema as h, loadConfig as i, isSafeExecutableValue as j, normalizeAllowFrom as k, validateConfigObjectWithPlugins as l, IMessageConfigSchema as m, migrateLegacyConfig as n, readConfigFileSnapshot as o, GoogleChatConfigSchema as p, resolveSubagentMaxConcurrent as q, createConfigIO as r, resolveConfigSnapshotHash as s, config_exports as t, OpenClawSchema as u, TelegramConfigSchema as v, DmConfigSchema as w, resolveTelegramCustomCommands as x, TELEGRAM_COMMAND_NAME_PATTERN as y, parseConfigPath as z };