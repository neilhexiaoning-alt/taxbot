...
import { U as parseAgentSessionKey, s as resolveAgentWorkspaceDir } from "./agent-scope-BD88ooNs.mjs";
...
import { n as redactSensitiveText } from "./redact-DjVwGPIJ.mjs";
import { o as hashText, t as requireNodeSqlite } from "./sqlite-CG_dxLw3.mjs";
...
var QmdMemoryManager = class QmdMemoryManager {
	...
	indexPath;
	env;
	collectionRoots = /* @__PURE__ */ new Map();
	sources = /* @__PURE__ */ new Set();
	docPathCache = /* @__PURE__ */ new Map();
	sessionExporter;
	updateTimer = null;
	pendingUpdate = null;
	closed = false;
